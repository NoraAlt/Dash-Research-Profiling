...
def precompute_all_lda():
    ...
    failed_banks = []
    counter = 0
    bank_names = GLOBAL_DF["author1 Dep"].value_counts().keys().tolist()
    results = {}
    ...
    for bank in bank_names:
        try:
            ...
            add_stopwords(bank)
            bank_df = GLOBAL_DF[GLOBAL_DF["author1 Dep"] == bank]
            ...
            print("SOMETHING WENT HORRIBLY WRONG WITH DEPT: ", bank)
